...
import {
  Send, RefreshCw, Phone, MoreHorizontal, CheckCircle2, Home,
  ...
  blocks: [
    {
      type: "text",
      content:
        "Hi 👋 — I'm your Property Assistant. I can search for homes to buy or rent, explore neighborhoods, check new projects, calculate EMIs, schedule viewings, and walk you through the paperwork. What are you looking for today?",
    },
  ],
  suggestions: ["3 BHK for sale in Vesu", "2 BHK rentals in Adajan", "EMI calculator", "Show new projects"],
};
...
export default function App() {
  ...
  return (
    <div style={{
      background: "radial-gradient(ellipse at top right, #0F1F1A 0%, #081410 50%, #050506 100%)",
      ...
      <div className="relative mx-auto px-6 py-8" style={{ maxWidth: 1400 }}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-lg font-serif" style={{ color: "white" }}>
                Property Assistant<span style={{ color: ACCENT }}>.</span>
                <span style={{ color: "rgba(255,255,255,0.4)" }}> Find your place, smarter.</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl border overflow-hidden flex flex-col"
            ...
            <div className="px-5 py-4 border-b flex items-center justify-between"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-medium" style={{ color: "white" }}>Property Assistant</div>
                  <div className="text-11" style={{ color: "rgba(255,255,255,0.4)" }}>AI real estate companion</div>
                </div>
              </div>
            ...
            <div className="px-5 pt-3 pb-3 border-t" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
              ...
              <div className="flex items-center gap-2">
                <input type="text" value={input}
                  ...
                  placeholder="Ask anything about properties…" disabled={loading}
          ...
          <aside className="space-y-4">
            ...
            <div className="rounded-2xl border p-5"
              ...
              <div className="space-y-2.5">
                {[
                  "Search homes to buy or rent",
                  "Neighborhood & market overviews",
                  "Active projects from RERA developers",
                  "EMI & affordability calculators",
                  "Schedule property viewings",
                  "Paperwork & due-diligence checklists",
                ].map((t, i) => (
            ...
            <div className="rounded-2xl border p-5"
              style={{ background: "rgba(255,255,255,0.015)", borderColor: "rgba(255,255,255,0.06)" }}>
              <div className="text-10 uppercase tracking-tightest2 mb-3" style={{ color: "rgba(255,255,255,0.4)" }}>Fair-housing principles</div>
              <div className="space-y-2.5">
                {[
                  "Refuses discriminatory filters",
                  "Won't share owner data directly",
                  "Flags coded proxy language",
              ...
              <div className="mt-4 pt-4 border-t flex items-center gap-2 text-10"
                ...
                Demo only — fictional listings & data
              </div>
            </div>
          </aside>
        </div>
        ...
        <footer className="mt-10 pt-6 border-t flex items-center justify-between text-11"
          ...
          <div>Find your place, smarter.</div>
          <div className="italic font-serif">A conversational AI real estate demo.</div>
        </footer>
      </div>
    </div>
  );
